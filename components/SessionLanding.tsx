...
import { Play, Plus, Clock, Sparkles, Building2, MapPin, Trash2, Cloud, ArrowLeftRight } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto px-4 py-10 space-y-8">
      <div className="text-center space-y-3">
        ...
        <p className="text-xs sm:text-sm text-slate-400 font-mono">
          Court Owner & Venue Management Portal
        </p>
        ...
        <div className="flex items-center justify-center space-x-3">
          <button
            ...
            className="inline-flex items-center space-x-1.5 px-3.5 py-1 rounded-full bg-[#0c2e1b] hover:bg-[#14532d] border border-emerald-600 text-xs font-mono text-emerald-300 transition"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {venues.length === 0 ? (
            <div className="sm:col-span-2 py-10 text-center text-slate-500 font-mono text-xs italic bg-[#0b1220] rounded-2xl border border-slate-800">
              No saved venues found. Click <strong className="text-white">+ New Court Venue</strong> to register your location.
            </div>
          ) : (
            venues.map(v => {
              ...
              return (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 text-[11px] font-mono text-slate-300 pt-2 border-t border-slate-800/80">
                    <div>{v.settings?.default_courts || 4} Courts</div>
